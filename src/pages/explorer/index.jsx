...
function Discover() {
  ...
  const handleFilter = (position) => {
    console.log('handle filter:',position)
      if(position === 1){
  ...
  return (
    <AnimatedPage>
      <div className="pb-20 discover-page">
              ...
              <div className="flex items-center right">
                ...
                <div className="relative ml-5 sort-dropdown">
                  ...
                  >
                    ...
                    <option value="2">Date Listed: Viewer Count</option>
                  </select>
                </div>
              </div>
            </div>
                      ...
                      >
                        <li className="flex items-center mb-2">
                          <input
                            ...
                            checked={filterNow}
                          />{" "}
                          <label className="text-sm" htmlFor="buynow">
                            Buy now
                          </label>
                        </li>
                        <li className="flex items-center mb-2">
                          ...
                          />{" "}
                          <label className="text-sm" htmlFor="onauction">
                            On auction
                          </label>
                        </li>
                        <li className="flex items-center mb-2">
                        ...
                        {/* <li className="flex items-center mb-2">
                          <input
                            ...
                            name="genesis"
                            id="genesis"
                            onChange={() => setFilterGenesis(!filterGenesis)} 
                            checked={filterGenesis}
                          />{" "}
                          <label className="text-sm" htmlFor="genesis">
                            Genesis NFTs
                          </label>
                        </li>
                        <li className="flex items-center mb-2">
                          <input
                            ...
                            name="hasoffers"
                            id="hasoffers"
                            onChange={() => setFilterOffers(!filterOffers)} 
                            checked={filterOffers}
                          />{" "}
                          <label className="text-sm" htmlFor="hasoffers">
                            Has offers
                          </label>
                        </li> */}
                      </ul>
